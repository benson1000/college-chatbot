import numpy as np  #provides support for large, multi-dimensional arrays and matrices, along with a collection of functions for performing mathematical operations on these arrays.
import pandas as pd

import nltk   ##natural language toolkit for human interaction data
import json  #this is a module for working with json files. that is #to read the json files (dataset ) that we need to train our model
import pickle  #for saving our trained and tested model
...
#  model more accurate
        ...
        training = np.array(training)          #convert training to numpy array
